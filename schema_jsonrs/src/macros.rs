...
/// The default settings currently conform to [JSON Schema 2020-12](https://json-schema.org/specification-links#2020-12), but this is liable to change in a future version of SchemaJsonrs if support for other JSON Schema versions is added.
///
...
macro_rules! json_schema {
    (
        ...
        $crate::Schema::try_from($crate::_private::serde_jsonc2::jsonc!({$($json_object)*})).unwrap()
    };
    (true) => {

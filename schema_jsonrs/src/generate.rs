...
use serde::Serialize;
use serde_jsonc2::{Map as JsonMap, Value};
...
impl SchemaSettings {
    ...
    /// # Example
    /// ```
    /// use schema_jsonrs::generate::{SchemaGenerator, SchemaSettings};
    ///
...
/// # Example
/// ```
/// use schema_jsonrs::{JsonSchema, SchemaGenerator};
///
/// #[derive(JsonSchema)]
/// struct MyStruct {
///     foo: i32,
...
impl SchemaGenerator {
    ...
    /// # Example
    /// ```
    /// use schema_jsonrs::SchemaGenerator;
    ///
    /// let generator = SchemaGenerator::default();
    ...
    pub fn root_schema_for_value<T: ?Sized + Serialize>(
        &mut self,
        value: &T,
    ) -> Result<Schema, serde_jsonc2::Error> {
        ...
        if let Ok(example) = serde_jsonc2::to_value(value) {
...
/// # Example
/// ```
/// use schema_jsonrs::transform::Transform;
/// use schema_jsonrs::generate::GenTransform;
///
/// #[derive(Debug, Clone)]
/// struct MyTransform;
///
/// impl Transform for MyTransform {
///   fn transform(&mut self, schema: &mut schema_jsonrs::Schema) {
///     todo!()
///   }
/// }
///
...
pub trait GenTransform: Transform + DynClone + Any + Send {
    ...
    /// ```
    /// use schema_jsonrs::generate::SchemaSettings;
    /// use schema_jsonrs::transform::ReplaceBoolSchemas;
    ///

...
/// This module is only public for use by `schema_jsonrs_derive`. It should not need to be used by code
/// outside of `schema_jsonrs`, and should not be considered part of the public API.
#[doc(hidden)]
pub mod _private;
pub mod generate;
pub mod transform;
...
/// ```
/// use schema_jsonrs::{SchemaGenerator, Schema, JsonSchema, json_schema};
/// use std::borrow::Cow;
///
